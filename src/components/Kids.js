...
import './Women.css'; // Make sure you have a separate CSS file for Kids
import pic1 from '../images/kids/kidscircle.avif';
import pic2 from '../images/kids/kidscircle2.avif';
import pic3 from '../images/kids/kidscircle3.avif';
            ...
            <div className='circles'>
                ...
                <div className='slider'>
                    <div className='slide-circle'>
                        <img src={pic1} alt='Girls'/>
                        <div>Girls</div>
                    </div>
                    <div className='slide-circle'>
                        <img src={pic2} alt='Boys'/>
                        <div>Boys</div>
                    </div>
                    <div className='slide-circle'>
                        <img src={pic3} alt='Kids Bedding'/>
